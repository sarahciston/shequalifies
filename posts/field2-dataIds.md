...
>"As part of automated decision-making regimes, data are exploited to distinguish between individuals and social groups [and] to enact difference across a range of times and spaces" (Lupton 2020, 123).
...
Lupton (2020) calls for an 'ethics of care' that can reconceptualize "personal data by re-humanizing them" (123), in part to "think about digital data as forms of matter" (123)---even as "a new form of human remains" (125). To take an ethical stance with data assemblages, she argues, means not assuming data can 'speak for' anyone and requires asking "whose interests are served or neglected when agential cuts are made in response to digital datasets?" (124). _see also my data decomp problem_
...
Lupton cites an example of an artistic intervention that connects some of the historical brutalities mentioned here to the contemporary dataveillance practices:
...
She argues "Creative design- and arts-based approaches to personal data can begin to reveal the more-than-representational dimensions of data assemblages, particularly the affective and sensory aspects that may be difficult to articulate in conventional modes" (Lupton 2020, 66).

"'data sweat', 'data trash', 'data bodies', 'data doubles'" (46)

Barad's "diffractive reading" which Lupton uses, McPherson's "lenticular" analysis, Barad's "intra-action", data as medium (mediation) (Kember & Zylinska) "embodied remediation", (Posner), 
...
"data trauma" a term used "to describe the compound effects of navigating digital infrastructures created to exploit, categorize, and discard personhood" (Olivia McKayla Ross, [@cyberdoula](https://www.instagram.com/cyberdoula/)). 
