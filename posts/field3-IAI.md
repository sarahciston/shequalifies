...
Ruja Benjamin "the New Jim Code"
...
_So how do I make intersectional AI?_ For more info, see the other zines in this library.
...
Check out these makers and organizations helping envision different computational futures (an utterly non-exhaustive list):
...
#### design for a feminist server (anarchoserver.org via Dunbar-Hester 2020, 113--114)
